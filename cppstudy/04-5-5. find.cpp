...
MyString& MyString::assign(const MyString& str) {
	// if (str.string_length > string_lenth) {
	...
	// 그리고 굳이 str.string_length + 1 ~ string_lenth 부분은 초기화
...
int main() {
	MyString str1("this is a very very very long string");
